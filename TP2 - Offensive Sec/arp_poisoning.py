...
class ArpSpoofer:
    ...
    def spoof(self, target, spoofed):
        ...
        print(Fore.YELLOW + f"Niko prends {target} pour pentakill {spoofed}")
    ...
    def restore(self, dest_ip, source_ip):
        ...
        scapy.send(packet, iface=self.interface, verbose=False)
        print(Fore.GREEN + f"on remonte tout de 4s.")
